...
namespace Pharmacy_Management_System
{
    public partial class Stock : Form
    {
        ...
        private void btnUpdateStock_Click(object sender, EventArgs e)
        {
            ...
            obj.con.Close();
            cmbProductTypeEditStock.Text = "Medicine Type";
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            expDate = Convert.ToDateTime(dateEpr.Text.Trim());
            ...
            if (productName != "" && productType != "" && txtUnitWholeSalePrice.Text != "" && txtUniteSalePrice.Text != "" && txtNewPurchasePrice.Text != "" && txtNewPurchaseQuantity.Text != "")
            {
                ...
                {
                    //Insertions Medicine
                    DialogResult confirm = MessageBox.Show("Do you want to Add New Stock With Medicine ? \n Product Name: " + productName + " \nType     :\t   " + productType + " \nSize     :\t   " + productSize + "\nTotal Stock   :" + newPurchaseQuantity, "Confirmation", MessageBoxButtons.YesNo);
                    if (confirm == DialogResult.Yes)
                    {
                        ...
                        resetAddNewStock();
                        obj.con.Close();
                        MessageBox.Show("Add Medicine and Stock","Sucssesfully");
                        pnlStockMenu.Visible = true;
                        pnlAddNewStock.Visible = false;
                        return;
                    }
        ...
        void resetAddNewStock()
        {
            ...
            txtProductName.Text = "Medicine Name";
            cmbProductType.Text = "";
            txtProductSize.Text = "";
            txtCurentStock.Text = "";
        ...
        {/*
            ...
            cmbProductType.Text = "Please Select Medicine Type ";
          * */
        }
        ...
        private void cmbProductTypeEditStock_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            txtProductSizeEditStock.Text = "Medicine Size";
        }
        ...
        void resetEditStock()
        {
             ...
             txtProductNameEdit.Text = "Search Medicine";
        ...
        private void btnSaveEditStock_Click(object sender, EventArgs e)
        {
            ...
            expDate = Convert.ToDateTime(dateNewExpriyEditStock.Text.Trim());
            upDate = DateTime.Now.Date;
        ...
        private void bntExpiryDate_Click(object sender, EventArgs e)
        {
            DateTime today = DateTime.Now.Date;
            obj.con.Open();
            DataTable dt = new DataTable();
            SqlDataAdapter adapt = new SqlDataAdapter("select *  from tblStocks where ExpiryDate < '"+ today +"'", obj.con);
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            obj.con.Close();
            pnlViewExpiryStock.Visible = true;
            pnlStockMenu.Visible = false;
            lblTitle.Text = "Date Expiry Stocks";
        }
